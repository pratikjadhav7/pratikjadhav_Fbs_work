...
public class PLayerHierarchy {
    ...
    public static void main(String[] args) {
           CricketPlayer c = new CricketPlayer("MSD","India",43,255,7,5660,10,"Right Hand","Right Arm");
           c.display();

           System.out.println("");
           
           FootballPlayer f = new FootballPlayer("Ronaldo","Portugal",40, 1300,7,1200,"Wing-half Forward");
           f.display();
